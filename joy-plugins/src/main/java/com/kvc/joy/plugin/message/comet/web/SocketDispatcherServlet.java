...
import com.kvc.joy.plugin.message.comet.core.*;
import com.kvc.joy.plugin.message.comet.support.JsonProtocolUtils;
import com.kvc.joy.plugin.message.comet.support.ObjectFactoryBuilder;
import com.kvc.joy.plugin.message.comet.web.utils.RequestUtils;
...
public class SocketDispatcherServlet extends AbstractDispatcherServlet {
	...
	protected CometConfigMetadata readCometConfig() {
		...
		if (StringTool.isBlank(dispatcherConfigLocation)) {
...
//				this.getServletContext());
        ...
        CometConfigMetadata cometConfig = (CometConfigMetadata) wac.getBean("cometConfigMetadata");
...
//        cometConfig.setTimeout(80000);
//        cometConfig.addProperty("objectFactory", "SpringObjectFactory");
//        CometMetadata cometMetadata = new CometMetadata();
//        cometMetadata.setRequest("/test.comet");
//        cometMetadata.setHandler("testComet");
//        cometConfig.addCometMetadata(cometMetadata);
